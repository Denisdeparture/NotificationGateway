...
namespace BuisnesLogic.Service.Safety
{
    public class SaltPassword 
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(password) | string.IsNullOrWhiteSpace(salt) | string.IsNullOrWhiteSpace(hashpassword)) throw new ArgumentNullException($"Params in {Compare} were null");
        ...
        {
            if (string.IsNullOrWhiteSpace(password)) throw new ArgumentNullException("password was null");
